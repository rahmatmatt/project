				...
				<tbody>
                  ...
                  foreach ($treatment->result_array() as $t) :
                    ...
                    <tr>
					  ...
					  <td><?php echo $t['baits']; ?>
					  <td><?php echo $t['hole']; ?>
					  <td><i style="color: white;"><?=$t['score']?></i><input type="number"  name="score" id="<?=$t['id']?>" onchange="saveData(<?=$t['id']?>)" value="<?=$t['score']?>"   min="0" max="1" ></td>				   					 
				  </tr>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" align="center" style="background-color:#66FFCC" ><b  style="font:Arial, Helvetica, sans-serif">PERINGATAN!!!</b></h5>
			</div>
