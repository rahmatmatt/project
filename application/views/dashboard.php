      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Estate</span>
    ...
    <section class="contenter">
      ...
      <div class="col-md-6">
        ...
        <div class="col-md-6">
		 <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Palm Age </h3>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Trial Year </h3>
            ...
            <center> <i class="fa fa-circle text-gray"></i> On going
              ...
              <div class="chart">
                <canvas id="areaChart" style="height:290px"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div></div>
          ...
          <!-- LINE CHART -->
                ...
                <canvas id="lineChart" style="height:250px" hidden></canvas>
              
          <!-- /.box -->

          <!-- BAR CHART -->
          
                <canvas id="barChart" style="height:230px" hidden></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
